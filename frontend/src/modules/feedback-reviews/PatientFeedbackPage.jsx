  ...
  return (
    <div className="pfp-page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0,1fr))', gap: '0.8rem', marginBottom: '1.2rem' }}>
        <div style={{ background: 'var(--nn-surface)', border: '1px solid var(--nn-border)', borderRadius: 20, padding: '0.85rem 1rem' }}>
      ...
      <style>{`
        ...
        .pfp-error-banner { display:flex; gap:0.75rem; align-items:center; background:color-mix(in srgb, var(--nn-danger) 10%, transparent); border:1px solid color-mix(in srgb, var(--nn-danger) 20%, transparent); border-radius:16px; padding:0.85rem 1.2rem; color:var(--nn-danger); font-size:0.85rem; font-weight:700; margin-bottom:1.5rem; }
        ...
        .ff-select {
          width:100%; padding:0.8rem 1rem; border:1.5px solid var(--nn-border); border-radius:16px;
        ...
        .ff-textarea {
          width:100%; padding:0.85rem 1rem; border:1.5px solid var(--nn-border); border-radius:16px;
        ...
        /* Toggle switch */
        .ff-toggle-row { display:flex; align-items:center; gap:0.85rem; cursor:pointer; padding:0.75rem; border-radius:16px; background:var(--nn-bg); border:1px solid var(--nn-border); transition:all 0.2s; user-select:none; }
        ...
        /* Serious complaint */
        .ff-serious-toggle { display:flex; align-items:center; gap:0.85rem; cursor:pointer; padding:0.85rem 1rem; border-radius:16px; border:1.5px dashed var(--nn-border); transition:all 0.2s; user-select:none; }
        ...
        .ff-complaint-box { background:color-mix(in srgb, var(--nn-danger) 6%, transparent); border-radius:16px; padding:1rem; border:1px solid color-mix(in srgb, var(--nn-danger) 20%, transparent); }
        ...
        .ff-submit {
          ...
          color:white; border:none; border-radius:16px; font-weight:800; font-size:0.9rem;
        ...
        .csc-card { background:var(--nn-surface); border:1.5px solid var(--nn-border); border-left:4px solid; border-radius:20px; padding:1.25rem; box-shadow:var(--nn-shadow); }
        ...
        .rhl-card { background:var(--nn-surface); border:1.5px solid var(--nn-border); border-radius:20px; padding:1.25rem; transition:border-color 0.2s, box-shadow 0.2s; }
        ...
        .rhl-edit-btn { background:color-mix(in srgb, var(--nn-primary) 10%, transparent); border:1px solid color-mix(in srgb, var(--nn-primary) 25%, transparent); color:var(--nn-primary); padding:0.4rem; border-radius:12px; cursor:pointer; display:flex; align-items:center; transition:all 0.2s; }
        ...
        .rhl-tag { background:var(--nn-surface-secondary); color:var(--nn-text-secondary); font-size:0.65rem; font-weight:700; padding:0.2rem 0.55rem; border-radius:8px; border:1px solid var(--nn-border); }
        body.dark .rhl-tag { background:rgba(255,255,255,0.05); color:var(--nn-text-disabled); border-color:rgba(255,255,255,0.07); }
        .rhl-edit-textarea { width:100%; padding:0.75rem 0.9rem; border:1.5px solid color-mix(in srgb, var(--nn-primary) 30%, transparent); border-radius:14px; font-size:0.88rem; font-family:inherit; resize:vertical; background:var(--nn-bg); color:var(--nn-text-main); box-sizing:border-box; margin:0.5rem 0; }
        ...
        .rhl-save-btn { display:flex; align-items:center; gap:0.4rem; background:var(--nn-primary); color:white; border:none; padding:0.55rem 1.1rem; border-radius:12px; font-weight:800; font-size:0.8rem; cursor:pointer; }
        .rhl-cancel-btn { display:flex; align-items:center; gap:0.4rem; background:var(--nn-surface-secondary); color:var(--nn-text-muted); border:1px solid var(--nn-border); padding:0.55rem 1.1rem; border-radius:12px; font-weight:800; font-size:0.8rem; cursor:pointer; }
        ...
        .rhl-complaint-chip { display:inline-block; margin-top:0.6rem; background:color-mix(in srgb, var(--nn-danger) 10%, transparent); border:1px solid color-mix(in srgb, var(--nn-danger) 22%, transparent); color:var(--nn-danger); font-size:0.7rem; font-weight:700; padding:0.3rem 0.7rem; border-radius:10px; }
      `}</style>
    </div>
  );
};
